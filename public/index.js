// Cart Context (declared early for all components)
...
const productsData = [
  {
    id: 1,
    name: "Camiseta Oversized Graphic",
    price: 129.9,
    oldPrice: 159.9,
    image:
  ...
  },
  {
    ...
    price: 249.9,
    image:
      "https://images.unsplash.com/photo-1588117305388-c2631a279f82?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "moletons",
  },
  {
    id: 3,
...
const carouselData = [
  {
    ...
    description:
      "Aproveite os melhores descontos em peças selecionadas. Edição limitada!",
    image:
      "https://images.unsplash.com/photo-1463100099107-aa0980c362e6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
  ...
  },
  {
    ...
    description:
      "As peças mais frescas e estilosas para o verão já estão disponíveis!",
    image:
      "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1620&q=80",
    buttonText: "Ver Coleção",
  },
  {
    id: 3,
    title: "FRETE GRÁTIS EM TODAS AS COMPRAS",
    description:
      "Aproveite o frete grátis em todos os produtos durante o mês de lançamento!",
    image:
    ...
    <section className="hero">
      <div className="container hero-content animate-slide-up">
        ...
        <h1 className="hero-title">
          ESTILO URBANO <span>QUE IMPACTA</span>
        </h1>
        <p className="hero-description">
          Descubra as peças mais exclusivas da cultura streetwear que combinam
          conforto, estilo e atitude.
        </p>
      ...
      <div className="container">
        ...
        <div className="categories-grid">
          {categoriesData.map((category, index) => (
            <div
              key={category.id}
              className={`category-card animate-fade-in delay-${index}`}
            >
              <img
                src={category.image}
                alt={category.name}
      ...
      <div className="container">
        ...
        <div className="filter-container">
          <div className="filter-tabs">
            ...
            <button
              className={`filter-tab ${filter === "camisetas" ? "active" : ""}`}
            ...
            <button
              className={`filter-tab ${filter === "calcas" ? "active" : ""}`}
              onClick={() => setFilter("calcas")}
            >
              <i className="fas fa-user-tie"></i>
              Calças
            </button>
            <button
              className={`filter-tab ${filter === "tenis" ? "active" : ""}`}
            ...
            <button
              className={`filter-tab ${filter === "acessorios" ? "active" : ""}`}
              onClick={() => setFilter("acessorios")}
            >
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              A mais nova loja de streetwear do Brasil, trazendo as melhores
              marcas e tendências para você se expressar através da moda.
            </p>
          ...
          <div className="footer-contact">
            ...
            <ul className="contact-info">
              <li>
                <i className="fas fa-map-marker-alt"></i> Rua das Tendências,
                123 - São Paulo, SP
              </li>
              <li>
                <i className="fas fa-phone"></i> (11) 9999-9999
              </li>
              <li>
                <i className="fas fa-envelope"></i> contato@urbanstreet.com.br
              </li>
              <li>
                <i className="fas fa-clock"></i> Seg a Sex: 9h às 18h | Sáb:
                10h às 16h
              </li>
            </ul>
          </div>
